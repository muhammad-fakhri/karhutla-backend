            ...
            editable={{
              onRowAdd: (newData) =>
                new Promise((resolve, reject) => {
                  DaopsService.addDaops(newData).then(async (result) => {
                    if (result.success) {
                      ...
                      setValues({
                        ...values,
                        alertMessage:
                          "Tambah Daerah Operasi Gagal, " + result.message[0],
                        successAlert: false,
                      });
                      reject();
                    }
              ...
              onRowUpdate: (newData, oldData) =>
                new Promise((resolve, reject) => {
                  DaopsService.updateDaops(newData, oldData).then((result) => {
                    if (result.success) {
                      ...
                      setValues({
                        ...values,
                        alertMessage:
                          "Update Daerah Operasi Gagal, " + result.message[0],
                        successAlert: false,
                      });
                      reject();
                    }
              ...
              onRowDelete: (oldData) =>
                new Promise((resolve, reject) => {
                  DaopsService.deleteDaops(oldData).then((result) => {
                    if (result.success) {
                      ...
                      setValues({
                        ...values,
                        alertMessage:
                          "Hapus Daerah Operasi Gagal, " + result.message[0],
                        successAlert: false,
                      });
                    }
                    showAlert();
