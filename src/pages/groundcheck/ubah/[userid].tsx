...
function EditPenggunaGroundcheckPage() {
	...
	useEffect(() => {
		const fetchData = async () => {
			const result = await getDataUserGc(userid as string)
			if (result.success) {
				console.log(result)
				const dataProvinsi = await getAllProvinsi()
				...
				if (user) {
					...
					const dataKecamatan = await getAllKecamatanGc(
						user.kabupaten
					)
...
export default ProtectRoute(EditPenggunaGroundcheckPage, false, true)
